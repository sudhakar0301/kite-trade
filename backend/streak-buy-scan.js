...
const BUY_5MIN_SCAN_PAYLOAD = {
    condition: 'MACD(12,26,9,macd,0) higher than MACD(12,26,9,signal,0) and Plus DI(14,0) higher than 25 and Plus DI(14,0) higher than ADX(14,0) and ADX(14,0) higher than Minus DI(14,0) and Minus DI(14,0) lower than 15 and RSI(14,0) higher than 60 and MACD(12,26,9,signal,0) higher than MACD(12,26,9,histogram,0)',
    scan_on: 'nifty_500',
    time_frame: '5min',
    chart_type: 'candlestick',
    slug: '5min-bullish'
